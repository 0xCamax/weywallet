 ...
 */
export declare type ResolvedResource<T extends Resource> = PulumiOmit<Resolved<T>, "urn" | "getProvider">;
...
declare type PulumiExclude<T, U> = T extends U ? never : T;
declare type PulumiOmit<T, K extends keyof any> = Pick<T, PulumiExclude<keyof T, K>>;
export {};
