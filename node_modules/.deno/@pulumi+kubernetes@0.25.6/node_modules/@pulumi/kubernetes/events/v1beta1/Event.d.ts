...
export declare class Event extends pulumi.CustomResource {
     ...
     * Deprecated field assuring backward compatibility with core.v1 Event type
     */
    readonly deprecatedSource: pulumi.Output<outputApi.core.v1.EventSource>;
    /**
     ...
     */
    readonly regarding: pulumi.Output<outputApi.core.v1.ObjectReference>;
    /**
     ...
     */
    readonly series: pulumi.Output<outputApi.events.v1beta1.EventSeries>;
    /**
