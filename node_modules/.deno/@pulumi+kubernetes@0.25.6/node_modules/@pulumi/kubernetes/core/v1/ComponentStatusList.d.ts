 ...
 */
export declare class ComponentStatusList extends pulumi.CustomResource {
    /**
     ...
     */
    readonly items: pulumi.Output<outputApi.core.v1.ComponentStatus[]>;
    /**
     ...
     */
    readonly kind: pulumi.Output<"ComponentStatusList">;
    /**
     * Standard list metadata. More info:
     * https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
     */
    readonly metadata: pulumi.Output<outputApi.meta.v1.ListMeta>;
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ComponentStatusList;
    /**
     * Returns true if the given object is an instance of ComponentStatusList.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ComponentStatusList;
    /**
