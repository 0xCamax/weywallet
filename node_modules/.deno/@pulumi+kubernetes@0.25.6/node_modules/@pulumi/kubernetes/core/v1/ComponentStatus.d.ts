 ...
 */
export declare class ComponentStatus extends pulumi.CustomResource {
    /**
     ...
     */
    readonly conditions: pulumi.Output<outputApi.core.v1.ComponentCondition[]>;
    /**
     ...
     */
    readonly kind: pulumi.Output<"ComponentStatus">;
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): ComponentStatus;
    /**
     * Returns true if the given object is an instance of ComponentStatus.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    static isInstance(obj: any): obj is ComponentStatus;
    /**
