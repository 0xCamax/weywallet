...
export declare class SelfSubjectRulesReview extends pulumi.CustomResource {
     ...
     */
    readonly spec: pulumi.Output<outputApi.authorization.v1beta1.SelfSubjectRulesReviewSpec>;
    /**
     * Status is filled in by the server and indicates the set of actions a user can perform.
     */
    readonly status: pulumi.Output<outputApi.authorization.v1beta1.SubjectRulesReviewStatus>;
    /**
